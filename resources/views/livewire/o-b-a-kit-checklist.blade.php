<div class="max-w-6xl mx-auto px-4 mt-6 bg-white rounded-xl py-4">
    <div class="gradient-bg text-white px-8 py-6 rounded-xl mb-6">
        <div class="flex items-center justify-center">
            ...
            <div>
                <h1 class="text-3xl font-bold">OBA KIT Checklist</h1>
                <p class="text-white/80 mt-1">Verify all required components and equipment</p>
            </div>
        </div>
    </div>
    ...
    <div class="overflow-x-auto rounded-lg border border-gray-200 shadow-sm table-container">
        <table class="w-full bg-white">
            <thead class="bg-gradient-to-r from-gray-50 to-gray-100">
                <tr>
                    <th class="px-4 py-4 text-left font-semibold text-gray-700 border-b border-gray-200 item-header sticky-header">
                    ...
                    <th class="px-3 py-4 text-center font-semibold text-gray-700 border-b border-gray-200 min-w-[80px]">
                        <div class="flex flex-col items-center">
                            <svg class="w-5 h-5 mb-1 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                            </svg>
                    ...
                    <th class="px-3 py-4 text-center font-semibold text-gray-700 border-b border-gray-200 min-w-[80px]">
                        <div class="flex flex-col items-center">
                            <svg class="w-5 h-5 mb-1 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"></path>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z"></path>
                            </svg>
                            <span class="text-xs">CAMERA/TABLET</span>
                        </div>
                    </th>
                    <th class="px-3 py-4 text-center font-semibold text-gray-700 border-b border-gray-200 min-w-[80px]">
                        <div class="flex flex-col items-center">
                            <svg class="w-5 h-5 mb-1 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2m-9 0h10m-10 0a2 2 0 00-2 2v14a2 2 0 002 2h10a2 2 0 002-2V6a2 2 0 00-2-2"></path>
                            </svg>
                            <span class="text-xs">CUTTER</span>
                        </div>
                    </th>
                    <th class="px-3 py-4 text-center font-semibold text-gray-700 border-b border-gray-200 min-w-[80px]">
                        <div class="flex flex-col items-center">
                            <svg class="w-5 h-5 mb-1 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="text-xs">STAMP PAD</span>
                        </div>
                    </th>
                    <th class="px-3 py-4 text-center font-semibold text-gray-700 border-b border-gray-200 min-w-[80px]">
                        <div class="flex flex-col items-center">
                            <svg class="w-5 h-5 mb-1 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <th class="px-3 py-4 text-center font-semibold text-gray-700 border-b border-gray-200 min-w-[80px]">
                        <div class="flex flex-col items-center">
                            <svg class="w-5 h-5 mb-1 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                            </svg>
                            <span class="text-xs">TAPE DISPENSER</span>
                        </div>
                    </th>
                    <th class="px-3 py-4 text-center font-semibold text-gray-700 border-b border-gray-200 min-w-[80px]" hidden>
                        <div class="flex flex-col items-center">
                            <svg class="w-5 h-5 mb-1 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path>
                            </svg>
                            <span class="text-xs">ZEBRA PEN</span>
                        </div>
                    </th>
                </tr>
            </thead>
            <tbody>
                <tr class="hover:bg-blue-50 transition-colors duration-200 border-b border-gray-100">
                    <td class="px-4 py-4 font-semibold text-gray-800 bg-gray-50 sticky-column">
                        <div class="flex items-center">
                            <div class="w-3 h-3 bg-green-500 rounded-full mr-3"></div>
                            <span>BEFORE OBA</span>
                        </div>
                    </td>
                    ...
                    <td class="px-3 py-4 text-center" hidden>
                        <div class="flex justify-center">
