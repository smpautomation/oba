...
class SimilaritiesChecking extends Component
{
    ...
    public function mount($checklist_id, $userIP){
        try{
            ...
            $this->sci_label_pn = $this->checklistInfo->sci_label_pn ? true : false;
            $this->qr_qa_pn = $this->checklistInfo->qr_qa_pn ? true : false;
            $this->qr_mc_pn = $this->checklistInfo->qr_mc_pn ? true : false;
            $this->qr_mgtz_pn = $this->checklistInfo->qr_mgtz_pn ? true : false;
